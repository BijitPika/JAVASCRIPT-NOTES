...
function hello(){
    ...
    if(!(/^[a-zA-Z]+ [a-zA-Z]+$/.test(Fname))){
        Fname1.style.outline="1px solid red";
        
        parag0.innerText="Full Name Should Have Two Words(Contains A Space ' ')"
    }
    else{
        Fname1.style.outline="1px solid green";
...
function hello1(){
    ...
    if(!(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(email))){
        ...
        email1.style.outline="1px solid red";
            ...
            email1.style.outline="1px solid green";
    ...
    function hello2(){
        ...
        if(!(mobile.length==10)){
        parag2.innerText="Mobile number format should be 111-222-3333 and maximum of 10 digit"
        mobile1.style.outline="1px solid red";
        
    }
    else{
        mobile1.style.outline="1px solid green";
...
function hello3(){
    ...
    if(!(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{8,15}$/.test(password))){
        ...
        password11.style.outline="1px solid red";
        
    }
    else{
        password11.style.outline="1px solid green";
...
function hello4(){
    ...
    if(bio.length<5){
        ...
        bio1.style.outline="1px solid red";
        
    }
    else{
        
        parag4.innerText=""
        bio1.style.outline="1px solid green";
        count++;
    }
